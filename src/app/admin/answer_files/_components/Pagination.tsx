...
import { AdminAnswerFilesQuery } from "../../../api/admin/answer_files/route";
      ...
      <div className="flex items-center">
        <p className="text-sm text-gray-700">
          ...
          <span className="font-medium">
            {(currentPage - 1) * parseInt(queryParams.limit || "50") + 1}
          </span>{" "}
          -
          <span className="font-medium">
            {Math.min(currentPage * parseInt(queryParams.limit || "50"), total)}
          </span>{" "}
          件を表示
        </p>
        <div className="ml-4">
